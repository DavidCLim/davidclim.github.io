...
export const TEACHERS = {
  random1: {
    ...
    hp: 22, speed: 95, reward: 3, size: 22, damage: 1, range: 10,
  ...
  random2: {
    ...
    hp: 28, speed: 85, reward: 3, size: 23, damage: 1, range: 10,
    desc: 'A Teacher. The base species of Docens Stultus. Seemingly weak, but still capable of defeating weaker students.',
    battleSprite: 'assets/regular_teacher_sprite.png',
  },
  p: {
    id: 'p', name: 'P', color: '#ff8a4c', glow: '#ffd8ba',
    hp: 55, speed: 100, reward: 8, size: 24, damage: 1, evasive: 0.18, range: 10,
  ...
  k: {
    ...
    hp: 170, speed: 48, reward: 15, size: 40, damage: 2, range: 10,
  ...
  t: {
    ...
    hp: 90, speed: 78, reward: 10, size: 27, damage: 2, range: 10,
  ...
  t_awakened: {
    ...
    hp: 900, speed: 55, reward: 60, size: 54, damage: 5, boss: true, range: 12,
