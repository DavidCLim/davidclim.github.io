...
function cardClasses(card, colorOverride = card.color) {
  return ["card", colorOverride, `value-${card.value}`, card.type === "number" ? "number-card" : ""].filter(Boolean).join(" ");
}
...
function skipAllIcon() {
  return `<svg class="card-icon skip-all-icon" viewBox="0 0 64 64" aria-hidden="true"><g class="skip-all-people"><circle cx="24" cy="22" r="6"/><circle cx="40" cy="22" r="6"/><circle cx="32" cy="16" r="7"/><path d="M16 42c1-9 15-9 16 0"/><path d="M32 42c1-9 15-9 16 0"/><path d="M20 38c1-11 23-11 24 0"/></g><path d="M16 49 50 15" fill="none" stroke="#111111" stroke-width="10" stroke-linecap="round"/><path d="M16 49 50 15" fill="none" stroke="#ffffff" stroke-width="4" stroke-linecap="round"/><text x="32" y="59" text-anchor="middle" class="skip-all-label">ALL</text></svg>`;
}
...
function wildIcon(label = "") {
  const text = label ? `<text x="30" y="42" text-anchor="middle" class="wild-icon-label">${label}</text>` : "";
  return `<svg class="card-icon wild-icon" viewBox="0 0 60 76" aria-hidden="true"><defs><clipPath id="wild-oval"><ellipse cx="30" cy="38" rx="25" ry="34" transform="rotate(-24 30 38)"/></clipPath></defs><g clip-path="url(#wild-oval)"><rect x="0" y="0" width="30" height="38" fill="#e21b2d"/><rect x="30" y="0" width="30" height="38" fill="#ffd21f"/><rect x="0" y="38" width="30" height="38" fill="#0066cc"/><rect x="30" y="38" width="30" height="38" fill="#00a650"/></g><ellipse cx="30" cy="38" rx="25" ry="34" fill="none" stroke="#111111" stroke-width="5" transform="rotate(-24 30 38)"/>${text}</svg>`;
}
