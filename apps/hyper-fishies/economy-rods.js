// Final economy layer: tiny fish payouts and a longer expensive rod ladder.
...
rodCatalog.splice(0, rodCatalog.length,
  ...
  { id: 2, name: "Bamboo Rod", price: 350, luck: 1.08, control: 1.05, color: "#7fd36b", glow: "#d7ffc7", note: "A careful first upgrade." },
  { id: 3, name: "Coral Rod", price: 950, luck: 1.18, control: 1.10, color: "#ff7f73", glow: "#ffd2a7", note: "Bright reef luck." },
  { id: 4, name: "Tide Rod", price: 2400, luck: 1.32, control: 1.18, color: "#4ed8ff", glow: "#d9fbff", note: "Casts farther into the tide." },
  { id: 5, name: "Pearl Rod", price: 5800, luck: 1.50, control: 1.28, color: "#fff0c8", glow: "#ffffff", note: "Polished and reliable." },
  { id: 6, name: "Storm Rod", price: 13500, luck: 1.74, control: 1.41, color: "#8c77ff", glow: "#f0dcff", note: "Good for hard fights." },
  { id: 7, name: "Royal Rod", price: 31000, luck: 2.02, control: 1.56, color: "#ffd85f", glow: "#fff4ad", note: "A rich fisher's rod." },
  { id: 8, name: "Abyss Rod", price: 72000, luck: 2.36, control: 1.74, color: "#192a68", glow: "#88ffea", note: "Deep-water luck." },
  { id: 9, name: "Mythic Rod", price: 165000, luck: 2.76, control: 1.95, color: "#ff66e5", glow: "#ffd6fb", note: "For serious collectors." },
  { id: 10, name: "Hyper Rod", price: 360000, luck: 3.24, control: 2.18, color: "#6dffcb", glow: "#ffffff", note: "The first true endgame rod." },
  { id: 11, name: "Leviathan Rod", price: 780000, luck: 3.82, control: 2.44, color: "#00a6ff", glow: "#b8f7ff", note: "Made for monster water." },
  { id: 12, name: "Sunken Crown Rod", price: 1500000, luck: 4.50, control: 2.74, color: "#f7d65a", glow: "#fff7bd", note: "Royal treasure from below." },
  { id: 13, name: "Kraken Rod", price: 3200000, luck: 5.30, control: 3.08, color: "#6e37ff", glow: "#d8c7ff", note: "A rod with teeth." },
  { id: 14, name: "Celestial Rod", price: 7500000, luck: 6.25, control: 3.48, color: "#fff9ff", glow: "#cce9ff", note: "Almost unreal." },
  { id: 15, name: "Omega Hyper Rod", price: 15000000, luck: 7.40, control: 3.95, color: "#39ffb6", glow: "#ffffff", note: "The ocean bows a little." }
);
...
function drawRodShopSpeech(x, y) {
  ...
  ctx.textAlign = "left";
  wrapText("Fish sell cheap now. Save up for the huge rod ladder: rare rods cost serious treasure!", x + 24, y + 34, 390, 24);
  ctx.restore();
}
